...
public class Main3Activity_SaiyanSaga extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main3__saiyan_saga);
        ...
        vidaiv = findViewById(R.id.saiyanv);
        nom = findViewById(R.id.jugador2);
        vida = findViewById(R.id.vidas2);
        pun = findViewById(R.id.puntos2);
        e = findViewById(R.id.e2);
        iv = findViewById(R.id.sayan);
        ...
        getSupportActionBar().setIcon(R.mipmap.lvl2);
        this.setTitle("  Saiyan Saga");


        mp = MediaPlayer.create(this,R.raw.juegosayayin);
        mp.start();
        mp.setLooping(true);
    ...
    public void comprobar(View view){
        if(lvl==6){
            ...
            if(vidas>0){
                ...
                Intent intent = new Intent(this, Main4Activity_FreezerSaga.class);
            ...
            if(lvl == 1){
                if(op4.isChecked()){
                    lvl++;
                    int id = getResources().getIdentifier("nappa", "drawable", getPackageName());
                    iv.setImageResource(id);
                    op1.setText("Ten Shin Han");
                    op2.setText("Spopovich");
                    op3.setText("Nappa");
                    op4.setText("Chaos");
                ...
                if(op3.isChecked()){
                    lvl++;
                    int id = getResources().getIdentifier("saibaman", "drawable", getPackageName());
                    iv.setImageResource(id);
                    op1.setText("Cell Junior");
                    op2.setText("Saibaman");
                    op3.setText("Dende");
                    op4.setText("Guerrero Semilla");
                ...
                if(op2.isChecked()){
                    lvl++;
                    int id = getResources().getIdentifier("veguetasayan", "drawable", getPackageName());
                    iv.setImageResource(id);
                    op1.setText("Vegeta");
                    op2.setText("Rey Vegeta");
                    op3.setText("Baby");
                    op4.setText("Tarble");
                ...
                if(op1.isChecked()){
                    lvl++;
                    int id = getResources().getIdentifier("gokukaio", "drawable", getPackageName());
                    iv.setImageResource(id);
                    op1.setText("Turles");
                    op2.setText("Goku SS Dios");
                    op3.setText("Goku Kaio Ken");
                    op4.setText("Super Goku");
                ...
                if(op3.isChecked()) {
                    lvl++;
                    int id = getResources().getIdentifier("nivel2", "drawable", getPackageName());
                    iv.setImageResource(id);
